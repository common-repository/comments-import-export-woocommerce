...
class HW_Cmt_ImpExpCsv_Admin_Screen {
	...
	public function output() {
		...
		if ($curent_tab) {
			if ('settings' == $curent_tab) {
				$tab = 'settings';
			} else if ('help' == $curent_tab) {
				$tab = 'help';
			} else if ('othersolutions' == $curent_tab) {
				$tab = 'othersolutions';
			}
		}
    ...
    /**
     * Admin Page for othersolutions
     */
    public function admin_othersolutions_page() {
        include( 'views/html-hf-othersolutions-page.php' );
    }	
